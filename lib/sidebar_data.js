...
const messages = defineMessages({
  ...
  nationListHeader: 'Communities',
  areaListHeader: 'Communities in'
})
...
function getNationData (data, intl, nationName) {
  ...
  return {
    ...
    water: stats.water,
    waterRequired: stats.waterRequired,
    listTitle: nationName + ' ' + intl.formatMessage(messages.nationListHeader),
    list: list
  }
}
...
function getAreaData (data, intl, areaName) {
  ...
  return {
    ...
    water: stats.water,
    waterRequired: stats.waterRequired,
    listTitle: intl.formatMessage(messages.areaListHeader) + ' ' + areaName,
    list: list
  }
}
